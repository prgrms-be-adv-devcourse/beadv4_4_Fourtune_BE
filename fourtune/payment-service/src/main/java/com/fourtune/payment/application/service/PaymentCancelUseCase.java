...
public class PaymentCancelUseCase {
    ...
    public com.fourtune.payment.domain.entity.Refund cancelPayment(String cancelReason, Long cancelAmount, OrderDto orderDto) {
        ...
        com.fourtune.payment.domain.entity.Wallet payerWallet = paymentSupport.findWalletByUser(paymentUser).orElseThrow(
        ...
        com.fourtune.payment.domain.vo.PaymentExecutionResult result = paymentGatewayPort.cancel(payment.getPaymentKey(), cancelReason, requestAmount);
