 ...
 * 결제·정산 지급 흐름 검증은 payment-service 및 auction-service 쪽 테스트에서 수행하세요.
 * </p>
 *
 * @see com.fourtune.auction.boundedContext.payment.adapter.in.kafka.PaymentSettlementKafkaListener
...
class E2EIntegrationTest {
    ...
    void placeholder_phase2_payment_removed() {
        ...
        // PaymentSettlementKafkaListener → PaymentServiceClient 호출만 단위/통합 테스트로 검증 가능.
    }
}
