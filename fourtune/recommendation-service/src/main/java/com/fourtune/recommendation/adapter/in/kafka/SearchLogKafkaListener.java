...
public class SearchLogKafkaListener {
    ...
    @KafkaListener(topics = KafkaTopicConfig.SEARCH_LOG_EVENTS_TOPIC, groupId = "recommendation-search-group", containerFactory = "searchLogEventKafkaListenerContainerFactory")
